...
var format_SignedParcelNames = new ol.format.GeoJSON();
var features_SignedParcelNames = format_SignedParcelNames.readFeatures(json_SignedParcelNames, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_SignedParcelNames = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_SignedParcelNames.addFeatures(features_SignedParcelNames);
var lyr_SignedParcelNames = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_SignedParcelNames, 
                style: style_SignedParcelNames,
                popuplayertitle: "Signed Parcel Names (last updated 2/12/24)",
                interactive: false,
                title: '<img src="styles/legend/SignedParcelNames.png" /> Signed Parcel Names (last updated 2/12/24)'
            });
...
lyr_SignedParcelNames.set('fieldAliases', {'Opportunity Name': 'Opportunity Name', 'Account Name': 'Account Name', 'Lease Area (Acres or Square Feet)': 'Lease Area (Acres or Square Feet)', 'AO Link': 'AO Link', 'Site Lat/Long Coordinates (Latitude)': 'Site Lat/Long Coordinates (Latitude)', 'Site Lat/Long Coordinates (Longitude)': 'Site Lat/Long Coordinates (Longitude)', 'Market': 'Market', 'Utility': 'Utility', });
...
lyr_SignedParcelNames.set('fieldImages', {'Opportunity Name': 'TextEdit', 'Account Name': 'TextEdit', 'Lease Area (Acres or Square Feet)': 'TextEdit', 'AO Link': 'TextEdit', 'Site Lat/Long Coordinates (Latitude)': 'TextEdit', 'Site Lat/Long Coordinates (Longitude)': 'TextEdit', 'Market': 'TextEdit', 'Utility': 'TextEdit', });
...
lyr_SignedParcelNames.set('fieldLabels', {'Opportunity Name': 'header label - visible with data', 'Account Name': 'header label - visible with data', 'Lease Area (Acres or Square Feet)': 'header label - visible with data', 'AO Link': 'header label - visible with data', 'Site Lat/Long Coordinates (Latitude)': 'header label - visible with data', 'Site Lat/Long Coordinates (Longitude)': 'header label - visible with data', 'Market': 'header label - visible with data', 'Utility': 'header label - visible with data', });
lyr_SignedParcelNames.on('precompose', function(evt) {
